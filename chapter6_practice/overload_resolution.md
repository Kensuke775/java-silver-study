...
|---|---|---|---|
| 1-パート1 | long | long | 正解 |
| 1-パート2 | Integer | Integer | 正解 |
| 1-パート3 | できる | コンパイルできない（あいまい） | 誤り |
| 1-パート4 | 未回答 | Object | ー |
| 2-Q1 | A | A | 正解 |
| 2-Q2 | B | B | 正解 |

問題1のパート3（`null`を渡した際の曖昧性エラー）だけが誤り。問題2（super×オーバーロード/オーバーライド）は選択式で全問正解。`null`と複数の参照型オーバーロードが絡む場面は要復習。
